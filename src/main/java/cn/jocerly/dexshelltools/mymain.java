package cn.jocerly.dexshelltools;
...
public class mymain {
    ...
    public static void main(String[] args) {
        ...
        try {
            File payloadSrcFile = new File("force/app-release.apk");   //需要加壳的程序
            System.out.println("apk size:"+payloadSrcFile.length());
            File unShellDexFile = new File("force/app-release.dex");	//解客dex
            ...
            String str = "force/app-release.dex";
